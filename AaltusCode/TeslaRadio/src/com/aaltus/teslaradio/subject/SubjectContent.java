...
//        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.MODULATION.ordinal(), activity.getString(R.string.modulation_am_title), new int[]{R.layout.informative_info_detail_test, R.layout.informative_info_detail_test},ScenarioEnum.MODULATION));
        ...
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.SOUNDEMISSION.ordinal(), activity.getString(R.string.sound_emission_title), new int[]{R.layout.sound_emission}, new int[]{R.string.sound_emission_tutorial_p1}, ScenarioEnum.SOUNDEMISSION, R.drawable.tesla_electric_1));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.SOUNDCAPTURE.ordinal(), activity.getString(R.string.sound_capture_title), new int[]{R.layout.sound_capture}, new int[]{R.string.sound_capture_tutorial_p1}, ScenarioEnum.SOUNDCAPTURE, R.drawable.tesla_electric_1));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.MODULATION.ordinal(), activity.getString(R.string.modulation_title), new int[]{R.layout.modulation}, new int[]{R.string.modulation_tutorial_p1,R.string.modulation_tutorial_p2,R.string.modulation_tutorial_p3}, ScenarioEnum.MODULATION, R.drawable.tesla_electric_1));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.TRANSMIT.ordinal(), activity.getString(R.string.transmit_title), new int[]{R.layout.transmission}, new int[]{R.string.transmission_tutorial_p1,R.string.transmission_tutorial_p2}, ScenarioEnum.TRANSMIT, R.drawable.tesla_electric_1));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.RECEPTION.ordinal(), activity.getString(R.string.reception_title), new int[]{R.layout.reception}, new int[]{R.string.reception_tutorial_p1}, ScenarioEnum.RECEPTION, R.drawable.tesla_electric_1));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.FILTER.ordinal(), activity.getString(R.string.filter_title), new int[]{R.layout.filter}, new int[]{R.string.filter_tutorial_p1}, ScenarioEnum.FILTER, R.drawable.tesla_electric_1));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.DEMODULATION.ordinal(), activity.getString(R.string.demodulation_title), new int[]{R.layout.demodulation}, new int[]{R.string.demodulation_tutorial_p1,R.string.demodulation_tutorial_p2,R.string.playback_tutorial_p1}, ScenarioEnum.DEMODULATION, R.drawable.tesla_electric_1));
