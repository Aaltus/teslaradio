...
//        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.MODULATION.ordinal(), activity.getString(R.string.modulation_am_title), new int[]{R.layout.informative_info_detail_test, R.layout.informative_info_detail_test},ScenarioEnum.MODULATION));
        ...
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.MODULATION.ordinal(), activity.getString(R.string.modulation_title), new int[]{R.layout.modulation}, new int[]{R.string.modulation_tutorial_p1,R.string.modulation_tutorial_p2,R.string.modulation_tutorial_p3}, ScenarioEnum.MODULATION));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.TRANSMIT.ordinal(), activity.getString(R.string.transmit_title), new int[]{R.layout.transmission}, new int[]{R.string.transmission_tutorial_p1,R.string.transmission_tutorial_p2}, ScenarioEnum.TRANSMIT));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.RECEPTION.ordinal(), activity.getString(R.string.reception_title), new int[]{R.layout.reception}, new int[]{R.string.reception_tutorial_p1}, ScenarioEnum.RECEPTION));
        ...
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.DEMODULATION.ordinal(), activity.getString(R.string.demodulation_title), new int[]{R.layout.demodulation}, new int[]{R.string.demodulation_tutorial_p1,R.string.demodulation_tutorial_p2,R.string.playback_tutorial_p1}, ScenarioEnum.DEMODULATION));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.PLAYBACK.ordinal(), activity.getString(R.string.playback_title), new int[]{R.layout.playback}, new int[]{}, ScenarioEnum.PLAYBACK));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.REFERENCE.ordinal(), activity.getString(R.string.reference_title), new int[]{R.layout.references}, null, ScenarioEnum.REFERENCE));
        SubjectContent.addItem(new SubjectContent.SubjectItem(ScenarioEnum.ABOUTUS.ordinal(), activity.getString(R.string.about_us_title), new int[]{R.layout.about_us}, null, ScenarioEnum.ABOUTUS));
