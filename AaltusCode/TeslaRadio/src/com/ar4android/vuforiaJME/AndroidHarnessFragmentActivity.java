            ...
            switch (evt.getType()) {
                case KEY_UP:
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            AlertDialog dialog = new AlertDialog.Builder(AndroidHarnessFragmentActivity.this) // .setIcon(R.drawable.alert_dialog_icon)
                                    .setTitle(exitDialogTitle).setPositiveButton("Yes", AndroidHarnessFragmentActivity.this).setNegativeButton("No", AndroidHarnessFragmentActivity.this).setMessage(exitDialogMessage).create();
                            dialog.show();
                        }
                    });
                    break;
