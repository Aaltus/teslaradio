...
public class SuperimposeJME extends SimpleApplication  implements AnimEventListener { 
	...
	private float mForegroundCamFOVY = 33; // for a Samsung Galaxy SII
	...
	public void initForegroundScene() {
        ...
        ninja.scale(0.035f, 0.035f, 0.035f);
        ninja.rotate(0.0f, -4.0f, 0.0f);
	...
	public void initForegroundCamera(float fovY) {
		...
		fgCam.setLocation(new Vector3f(0f, 0f, 40f));
