/* VuforiaNative - RayPickingJME Example
 *
 * Example Chapter 6
...
class RayPickingJME_UpdateCallback : public QCAR::UpdateCallback
{   
...
RayPickingJME_UpdateCallback updateCallback;



JNIEXPORT void JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
{
...
JNIEXPORT void JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_switchDatasetAsap(JNIEnv *, jobject)
{
...
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_initTracker(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_initTracker");
...
JNIEXPORT void JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_deinitTracker(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_deinitTracker");
...
JNIEXPORT int JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_loadTrackerData(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_loadTrackerData");
...
JNIEXPORT int JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_destroyTrackerData(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_destroyTrackerData");
...
JNIEXPORT void JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_onQCARInitializedNative(JNIEnv *, jobject)
{
...
JNIEXPORT void JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_initApplicationNative(
                            JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_initApplicationNative");
    ...
    LOG("Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_initApplicationNative finished");
}


JNIEXPORT void JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_deinitApplicationNative(
                                                        JNIEnv* env, jobject obj)
{
    LOG("Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_deinitApplicationNative");
...
JNIEXPORT void JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_setProjectionMatrix(JNIEnv *, jobject)
{
    LOG("Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_setProjectionMatrix");
...
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_activateFlash(JNIEnv*, jobject, jboolean flash)
{
    return QCAR::CameraDevice::getInstance().setFlashTorchMode((flash==JNI_TRUE)) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_autofocus(JNIEnv*, jobject)
{
...
JNIEXPORT jboolean JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_setFocusMode(JNIEnv*, jobject, jint mode)
{
    int qcarFocusMode;
...
JNIEXPORT void JNICALL
Java_com_ar4android_rayPickingJME_RayPickingJME_initTracking(
                        JNIEnv* env, jobject obj, jint width, jint height)
{
    LOG("Java_com_ar4android_rayPickingJME_RayPickingJMEActivity_RayPickingJMERenderer_updateRendering");
